...
do: [tf.config.experimental.set_memory_growth(gpu, True) for gpu in tf.config.experimental.list_physical_devices("GPU")]
...
sentences_txt_path = os.path.join("E:/Capstone/Datasets/IAM_Sentences/ascii/sentences.txt")
sentences_folder_path = os.path.join("E:/Capstone/Datasets/IAM_Sentences/sentences")
